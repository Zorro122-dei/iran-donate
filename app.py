...
<head>
    ...
    <style>
        ...
        .btn { border: 1px solid #0ff; color: #0ff; background: transparent; padding: 12px; width: 100%; font-weight: bold; cursor: pointer; pointer-events: none; }
...
<body>
    ...
    <script>
        ...
        function copyIt(id) {
            ...
            // Визуальный эффект вместо alert
